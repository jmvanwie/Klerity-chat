export const keywords = ["aerospace", "rocket", "orbital mechanics", "propulsion", "thrust", "lift", "drag", "gravity"];
export const instructions = `**Task: Rocket Science & Aerospace Mechanics**
